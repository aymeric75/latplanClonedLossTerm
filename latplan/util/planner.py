...
sae = None
problem_dir = "/workspace/latplan/latplanClonedLossTerm/samples/sokoban_sokoban_image-20000-global-global-2-train_20000_CubeSpaceAE_AMA4Conv_kltune2/logs/05-11T07:43:01.194/sokoban-2-False/003-000"
network_dir = None
ama_version = None
...
def problem(path):
    # path : init.png
    # problem_dir : samples/sokoban_sokoban_image-20000-global-global-2-train_20000_CubeSpaceAE_AMA4Conv_kltune2/logs/05-11T07:43:01.194/sokoban-2-False/003-000
    print("problem_dir")
    print(problem_dir)
...
def init_goal_misc(p, cycle=1, noise=None, sae=None):
    # import sys
    import imageio
    import numpy as np
